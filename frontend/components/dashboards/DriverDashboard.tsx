...
const DriverDashboard = ({ initialUser: initialDashboardUser }: DriverDashboardProps) => {
  ...
  console.log("DriverDashboard - initialDashboardUser.driverStatus:", initialDashboardUser?.driverStatus);
  console.log("DriverDashboard - contextUser?.driverStatus:", contextUser?.driverStatus);
  console.log("DriverDashboard - authIsLoading:", authIsLoading);
  ...
  console.log("DriverDashboard - currentUser AFTER SELECTION - driverStatus (value):", currentUser.driverStatus);
