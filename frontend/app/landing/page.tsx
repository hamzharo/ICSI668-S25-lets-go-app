  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-200">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center space-x-2 sm:space-x-4">
            ...
            {/* Updated Link for Sign Up Button */}
      ...
      <main className="flex-grow">
        <section className="relative pt-16 pb-20 md:pt-24 md:pb-28 lg:pt-32 lg:pb-36 bg-gradient-to-b from-sky-50 via-slate-50 to-white dark:from-slate-800 dark:via-slate-800/50 dark:to-slate-900">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
            ...
            <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
              {/* Updated Link for Get Started Free Button */}
              <Link href="/register" asChild>
              ...
              {/* Updated Link for Find a Ride Button */}
              <Link href="/search-rides" asChild>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
              ...
              <div className="feature-card p-6 bg-slate-50 dark:bg-slate-800 rounded-xl shadow-lg hover:shadow-2xl transition-shadow">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300">
                  Driver verification and community reviews help ensure a secure journey for everyone. ( Content)
                </p>
              </div>
              ...
              <div className="feature-card p-6 bg-slate-50 dark:bg-slate-800 rounded-xl shadow-lg hover:shadow-2xl transition-shadow">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300">
                  Reduce your carbon footprint by sharing rides and making travel more sustainable. ( Content)
                </p>
              </div>
              ...
              <div className="feature-card p-6 bg-slate-50 dark:bg-slate-800 rounded-xl shadow-lg hover:shadow-2xl transition-shadow">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300">
                  Save money on fuel and vehicle maintenance by sharing travel expenses. ( Content)
                </p>
              </div>
              {/* Feature 4: Community Focused */}
              <div className="feature-card p-6 bg-slate-50 dark:bg-slate-800 rounded-xl shadow-lg hover:shadow-2xl transition-shadow">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300">
                  Connect with fellow travelers, make new friends, and enjoy a more social commute. ( Content)
                </p>
              </div>
              ...
              <div className="feature-card p-6 bg-slate-50 dark:bg-slate-800 rounded-xl shadow-lg hover:shadow-2xl transition-shadow">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300">
                  Our intuitive platform makes finding or offering a ride quick and hassle-free. ( Content)
                </p>
              </div>
              {/* Feature 6: Flexible Options */}
              <div className="feature-card p-6 bg-slate-50 dark:bg-slate-800 rounded-xl shadow-lg hover:shadow-2xl transition-shadow">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300">
                  Find rides for daily commutes, weekend trips, or long-distance travel. ( Content)
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Call to Action Section (Demo Data) */}
        <section className="py-16 md:py-24 bg-slate-100 dark:bg-slate-800">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="max-w-xl mx-auto text-lg text-slate-600 dark:text-slate-300 mb-8">
              Whether you're looking to save money, reduce your environmental impact, or simply enjoy a more social commute, Let's GO is here to connect you. ( Pitch)
            </p>
            {/* Updated Link for Sign Up Now Button */}
            <Link href="/register" asChild>
