...
import DriverEditProfileForm from '@/components/driver/DriverEditProfileForm';
import { User } from '@/types';
import { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'Edit Driver Profile (Demo)',
  description: 'Manage and update your driver profile information.',
};

const MOCK_DRIVER_USER_FOR_EDIT_PROFILE: User = {
  // ... (same mock data as before)
  id: 'demo-driver-123',
  firstName: 'Demo',
  lastName: 'Driver',
  email: 'demo.driver@example.com',
  username: 'demodriver99',
  phoneNumber: '+15551234567',
  bio: 'I am a friendly and experienced demo driver, ensuring safe and comfortable rides. I enjoy meeting new people and exploring the city!',
  role: 'DRIVER',
  profilePictureUrl: 'https://avatar.vercel.sh/demo-driver.png',
};

const EditDriverProfilePage = async () => {
  const currentUserForForm = MOCK_DRIVER_USER_FOR_EDIT_PROFILE;

  // The onProfileUpdate callback is removed from here
  // The DriverEditProfileForm will handle its own internal success/error feedback (e.g., toasts)

  return (
    <div className="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <DriverEditProfileForm
        currentUser={currentUserForForm}
        // onProfileUpdate prop is no longer passed
      />
    </div>
  );
};
